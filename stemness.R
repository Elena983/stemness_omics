...
# Author: Maycon Marção (bioinformatics), Felipe Segato
...
setwd("~/NAS/Lena/steinbock_all/stemness")
library(Seurat)
library(DropletUtils)


untar("/media/hd/maycon/Elena_stemness_request/CytAssist_11mm_FFPE_Human_Glioblastoma_spatial.tar.gz")

untar("/media/hd/maycon/Elena_stemness_request/CytAssist_11mm_FFPE_Human_Glioblastoma_filtered_feature_bc_matrix.tar.gz")


# Create a .h5
feature_bc_matrix <- Read10X(data.dir = "/media/hd/maycon/Elena_stemness_request/filtered_feature_bc_matrix")

write10xCounts("/media/hd/maycon/Elena_stemness_request/filtered_feature_bc_matrix.h5", feature_bc_matrix, type = "HDF5",
               genome = "GRCh38",
...
data.dir <- "/media/Lena/steinbock_all/stemness"
